    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center gap-44 pb-80">
        <div className="w-full h-screen relative">
          <img
            src="https://cdn.pixabay.com/photo/2020/02/22/08/02/vehicle-4869773_960_720.jpg"
            // https://www.armacell-beyond-better.com/sites/default/files/styles/hero_media_l/public/media/images/iStock-532129583.webp?h=06fc8605&itok=i9A0j84K"
            alt=""
        ...
        <div className="w-full h-screen flex items-center justify-between">
          ...
          <div className="w-1/2 h-full">
            <img
              src="https://cdn.pixabay.com/photo/2020/09/30/16/06/fireman-5616315_960_720.jpg"
              // https://www.armacell-beyond-better.com/sites/default/files/styles/cta_image_l/public/media/images/Armacell-Whitepaper-Fire%20Safety.webp?itok=MZ-c-vK-"
              alt=""
              className="w-full h-full"
            />
          </div>
        ...
        <div className="px-72">
          <div className="flex flex-col items-start justify-center gap-4">
            <h3 className="text-4xl font-bold text-lime-700">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Deserunt, modi? Animi officiis dolores atque?
            </h3>
            <p className="text-lg text-gray-600">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero
              delectus at expedita nulla quia officia, dicta reprehenderit iste
              soluta mollitia quisquam blanditiis consectetur alias debitis
              rerum ratione voluptate quaerat quos.
            </p>
          </div>
        ...
        <div className="w-full flex flex-col gap-20">
          ...
          <div className="flex items-center justify-center gap-8">
            <div className="w-4/12 h-auto">
              <img
                src="https://cdn.pixabay.com/photo/2017/08/25/00/55/fire-engine-2678866_960_720.jpg"
                // https://www.armacell-beyond-better.com/sites/default/files/styles/text_media/public/media/images/iStock-635732164.webp?itok=8SJ4VviX"
                alt=""
                className="w-full h-full"
              />
            </div>
