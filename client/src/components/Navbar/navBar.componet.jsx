...
function Navbar() {
  ...
  return (
    <div className="fixed w-full bg-gray-50 z-50">
      <div class="topnav">
        <a class="armacell" href="#arma cell"></a>
        <a class="contact" href="#contact">
          CONTACT US
      ...
      <div class="topnav1" id="myTopnav">
        ...
        <div class="dropdown">
          <button onClick={solutions} class="dropbtn">
            SOLUTIONS
            <VscChevronDown style={{ marginLeft: 175, marginTop: -12 }} />
            <i class="fa fa-caret-down"></i>
          </button>
          <div class="dropdown-content"></div>
        </div>
        <div class="dropdown">
          <button onClick={industry} class="dropbtn">
            INDUSTRIES
            <VscChevronDown style={{ marginLeft: 180, marginTop: -12 }} />
            <i class="fa fa-caret-down"></i>
          </button>
          <div class="dropdown-content"></div>
        </div>
        <div class="dropdown">
          <button onClick={about} class="dropbtn">
            ABOUT <VscChevronDown style={{ marginLeft: 155, marginTop: -12 }} />
            <i class="fa fa-caret-down"></i>
          </button>
          <div class="dropdown-content"></div>
        </div>
        <div class="dropdown">
          <button onClick={customer} class="dropbtn">
            CUSTOMER PROJECTS
            <VscChevronDown style={{ marginLeft: 225, marginTop: -15 }} />
            <i class="fa fa-caret-down"></i>
          </button>
          <div class="dropdown-content"></div>
        </div>
